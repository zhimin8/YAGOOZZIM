...
<body>
			...
			<div class="container">
				<div class="row">
					<div class="col-12 mb-4">
						<!-- course thumb -->
						<img src="${pageContext.request.contextPath}/resources/images/courses/course-single.jpg" class="img-fluid w-100">
					</div>
				</div>
				<!-- course info -->
				...
				<div class="row">
					...
					<hr>
					<form action="${pageContext.request.contextPath}/member/modifypw.do" method="post">
						<div class="col-12 mb-4">
							<h5 class="mb-3">CHANGE PASSWORD</h5>
							<div class="col-12 px-0">
								<input type="password" class="form-control mb-3" id="newPwd" name="newPwd" placeholder="PASSWORD">
	...
	function popup() {
		...
		var url = "${pageContext.request.contextPath}/member/deletemember.do";
		var name = "plzdontgo"
